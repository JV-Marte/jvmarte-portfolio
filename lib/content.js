...
export const projects = [
  ...
  },
  {
    ...
    // Optional screenshot strip — renders as clickable thumbnails that open a
    // lightbox (see components/Gallery.jsx). Only this project has one so far.
    gallery: [
      { src: "/assets/images/silencio/01-home.png", label: "Home / landing" },
      { src: "/assets/images/silencio/02-shop.png", label: "Shop catalog" },
      { src: "/assets/images/silencio/06-unlock.png", label: "VIP unlock" },
    ],
    cta: "Visit website",
  },
  {
