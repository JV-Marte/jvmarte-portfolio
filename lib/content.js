...
/* ------------------------------------------------------------------
   PACKAGES · fixed price website builds. Prices are USD for the build.
   `highlight` marks the tier the section leads with (one only).

   The four tiers differ by size, price, and turnaround. Everything in
   `packageIncludes` ships with all of them, so it is listed once under
   the cards rather than repeated four times.
   ------------------------------------------------------------------ */
export const packages = [
  {
    ...
    blurb: "One page that says who you are and points every visitor to one action.",
  },
  {
    name: "Start Up",
    scope: "4 pages",
    ...
    blurb: "Room for your services, your story, and a proper contact page.",
  },
  {
    name: "Standard",
    scope: "8 pages",
    ...
    highlight: true,
    blurb: "The full site most small businesses actually need, with nothing padded out.",
  },
  {
    name: "Complex",
    scope: "8 pages + complex features",
    price: "1,850",
    from: true,
    delivery: "15 day delivery",
    blurb: "Booking, e-commerce, dashboards, or automations built on top of the site.",
  },
];

// Perks every tier carries, listed on each card under the delivery time.
export const packagePerks = ["Free consultation", "1 month free revisions"];

// Shipped with every tier, shown once below the cards.
...
/* ------------------------------------------------------------------
   SUPPORT SERVICES · regular-job services that fit JV's financial
   management background. Keep the wording support-focused: bookkeeping
   support and admin organization, not licensed accounting claims.
   ------------------------------------------------------------------ */
export const supportServices = [
  {
    ...
    label: "Finance admin",
    blurb:
      "Help keeping income, expenses, receipts, and monthly records organized so the business owner is not guessing later.",
    items: [
      "Expense categorizing",
      "Receipt and transaction tracking",
      "Monthly income and expense summaries",
      "QuickBooks, Xero, Excel, or Sheets support",
    ],
  },
  {
    ...
    blurb:
      "Clean trackers and simple reports for sales, expenses, inventory, budgets, or weekly operations.",
    items: [
      "Google Sheets and Excel trackers",
      "Basic dashboards and formulas",
      "Sales, expense, and budget reports",
      "Organized files for handover",
    ],
  },
  {
    title: "CRM & Admin Operations",
    label: "Back-office systems",
    blurb:
      "Practical admin help for lead lists, customer records, follow ups, and the systems behind daily operations.",
    items: [
      "GoHighLevel CRM cleanup",
      "Lead and customer list organization",
      "Follow-up task tracking",
      "Data entry and process documentation",
    ],
  },
];
...
export const projects = [
  ...
  {
    slug: "azure-fitness-cafe",
    type: "Demo Project",
    status: "Live",
    featured: true,
    title: "Azure Sands · Fitness & Cafe",
    blurb:
      "Two more businesses on the condotel's codebase: a gym that captures memberships and a cafe that takes food orders, both run from the same admin dashboard.",
    problem:
    ...
    url: "https://azure-condotel.vercel.app/gym",
    image: "/assets/images/azure-fitness-cafe.webp",
    gallery: [
      {
        src: "/assets/images/azure-cafe-menu.webp",
        label: "Azure Sands Cafe menu: 29 dishes across seven sections, prices VAT inclusive",
      },
      {
        src: "/assets/images/azure-gym-membership.webp",
        label: "Membership sign up: six tiers from a day pass to an annual",
      },
      {
        src: "/assets/images/azure-gym-schedule.webp",
        label: "The weekly timetable, 13 coached sessions included with a membership",
      },
    ],
  },
  {
